...
2- **Alguns desses testes são End-to-end (e2e)?**
      -  Nào, pois os teste e2e (end-to-end) verifica se fluxo **completo** de um software esta de acordo com o planejado. Nesse caso, a gente realiza testes de APIs esperando respostas do endpoint.
